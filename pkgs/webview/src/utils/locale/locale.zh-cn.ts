export default {
  ...
  'maa.control.tooltip.scan-gamescope': '刷新已发现的 gamescope 实例列表',
  'maa.control.tooltip.display-list-gamescope': '浏览并选择 gamescope 实例（按显示编号）',
  'maa.control.tooltip.scan-wlr-compositor': '刷新已连接的 Wayland 合成器列表',
  'maa.control.tooltip.compositor-list-wlr': '浏览并选择 Wayland 合成器 socket',
  'maa.control.linux.portal-unsupported': '暂不支持 pipewire_source=Portal，请使用 Gamescope 模式',
  'maa.control.linux.display-no': '已选择显示编号',
  'maa.control.linux.wlr-socket-placeholder': 'Wayland socket 路径（如 /run/user/1000/wayland-0）',
  'maa.control.linux.compositor-matched': '已匹配到合成器：{0}',
  'maa.control.linux.uinput-width': 'uinput 屏幕宽度',
  'maa.control.linux.uinput-height': 'uinput 屏幕高度',
  ...
  'maa.control.controller.display-list': '显示列表',
  ...
  'maa.crop.settings.save-dir': '保存路径',
  'maa.crop.settings.save-dir-default': '默认',
  'maa.crop.settings.save-dir-pick': '选择…',
  'maa.crop.settings.save-dir-clear': '恢复默认',
  'maa.crop.tooltip.save-dir': '设置后，下载的裁剪图片将直接保存到该目录；未设置时使用默认位置',
