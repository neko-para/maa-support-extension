declare module 'json-source-map' {
  ...
  export interface ParseResult {
    ...
    pointers: {
      [key: string]: {
        value: {
          // The starting position of the value in the original JSON string.
          line: number
          column: number
          pos: number
        }
        valueEnd: {
          // The ending position of the value in the original JSON string.
          line: number
          column: number
          pos: number
        }
        key?: {
          // The starting position of the key in the original JSON string (for object properties).
          line: number
          column: number
          pos: number
        }
        keyEnd?: {
          // The ending position of the key in the original JSON string (for object properties).
          line: number
          column: number
          pos: number
        }
  ...
  export interface StringifyResult {
    ...
    pointers: {
      [key: string]: {
        value: {
          // The starting position of the value in the resulting JSON string.
          line: number
          column: number
          pos: number
        }
        valueEnd: {
          // The ending position of the value in the resulting JSON string.
          line: number
          column: number
          pos: number
        }
        key?: {
          // The starting position of the key in the resulting JSON string (for object properties).
          line: number
          column: number
          pos: number
        }
        keyEnd?: {
          // The ending position of the key in the resulting JSON string (for object properties).
          line: number
          column: number
          pos: number
        }
